...
mkdir types
printf '%s\n' 'import { createAuthBoundry } from "authboundry";' 'import { createAuthBoundryReact } from "authboundry/react";' 'createAuthBoundry(); createAuthBoundryReact({} as any);' > types/index.ts
